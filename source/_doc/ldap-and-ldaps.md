...
<h4>Note</h4>
We do not recommend using LDAP for single sign-on authentication as it is not secure.  The recommended approach for sites and the Dashboard is to use SAML. For details, see <a href="https://pantheon.io/guides/two-factor-authentication/"> Secure Your Site with Two-Factor Authentication</a>.
</div>
