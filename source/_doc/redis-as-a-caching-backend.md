...
The best and easiest way to update your core is by using Pantheon administration Dashboard. Take a look at the [wiki page](/docs/applying-upstream-updates) for the steps you will need to take to update, your project's code and get the most recent version of the `.gitignore`.
