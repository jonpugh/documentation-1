...
<hr>
### Boost
**Issue**: Boost is an unnecessary caching layer that may cause issues. Every site on Pantheon can leverage our robust Varnish infrastructure that caches pages for anonymous visitors at the highest possible performance. See [Working with Varnish](/docs/).
...
**Solution**: See [Varnish Caching - Drupal and WordPress Advanced Topics](https://pantheon.io/docs/caching-advancedtopics/) for details on how to bypass Varnish.
...
### Revive Old Post
**Issue**: Revive Old Post does not set a proper callback via OAuth and the Twitter module.  It attempts to use ["SERVER_NAME"] instead of the recommended ["HTTP_HOST"]. See [SERVER_NAME and SERVER_PORT on Pantheon](https://pantheon.io/docs/server_name-and-server_port/).
