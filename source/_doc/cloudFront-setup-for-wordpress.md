...
categories: [sites, wordpress]
tags: [code, domains, plugins]
---
...
Access your WordPress dashboard by appending `/wp-admin` to your [Development Site URL](/docs/#visit-the-dev-installation) and log in using your WordPress credentials.
