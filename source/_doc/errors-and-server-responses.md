...
When uploading an SSL certificate and you receive this message, it means you didn't paste in your private key. See [Loading SSH Keys](https://pantheon.io/docs/loading-ssh-keys/) for instructions.
