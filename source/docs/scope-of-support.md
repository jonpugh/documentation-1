...
- If your site is slow or modules aren't working, please see our [performance articles](/docs/#performance). Issues with the platform are posted on our [status page](http://status.getpantheon.com). If there are no platform events, the solution is probably within the site's code.
